...
private let alpha3ToAlpha2Map: [String: String] = [
    ...
    "POL": "PL", "PRT": "PT", "PRI": "PR", "QAT": "QA", "MKD": "MK",
...
extension String {
    /// Converts ISO 3166-1 alpha-3 country code to alpha-2 format
    /// - Returns: Two-letter country code (e.g., "US"), or nil if not a valid alpha-3 code
    var toAlpha2: String? {
        alpha3ToAlpha2Map[self.uppercased()]
    }
}
